...
const { isWindows } = require('@vicli/cli-shared-utils')
...
module.exports = (api, options) => {
  ...
  const cliServicePath = path.dirname(require.resolve('@vicli/cli-service'))
          ...
          plugins: [
            [
              require.resolve('babel-plugin-named-asset-import'),
              {
                loaderMap: {
                  svg: {
                    ReactComponent: '@svg/webpack?-svgo,+titleProp,+ref![path]'
                  }
                }
              }
            ]
